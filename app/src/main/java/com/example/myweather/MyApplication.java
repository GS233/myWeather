...
public class MyApplication extends Application{
    ...
    private CityDB openCityDB(){
        String path="/data" //数据库city.db的路径 /data/data/com.xxxxxxx/databases1/city.db
        ...
        Log.d(TAG,path);///data/data/com.xxxxxxx/databases1/city.db
