...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //接收name值
        String cityCode = bundle.getString("cityCode");
        Log.i("获取到的name值为",cityCode);
        ...
        btn_favor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity3.this, favorCityList.class);//Intent调用另一个Activity
                startActivity(i);
            }
        });
        ...
        btn_cityCodeSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity3.this, codeSearch.class);//Intent调用另一个Activity
                startActivity(i);
            }
        });
        ...
        btn_city.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity3.this, MainActivity2.class);//Intent调用另一个Activity
                startActivity(i);
            }
        });
        ...
        btn_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity3.this, "刷新成功", Toast.LENGTH_SHORT).show();
            }
        });
